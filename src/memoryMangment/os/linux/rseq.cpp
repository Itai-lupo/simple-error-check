...
volatile thread_local struct rseq r = {
	.cpu_id_start = 0, .cpu_id = (__u32)RSEQ_CPU_ID_UNINITIALIZED, .rseq_cs = 0, .flags = 0, .node_id = 0, .mm_cid = 0
...
USED_IN_RSEQ
__attribute__((optnone)) void handleRseq(const rseq_cs *cs, rseqCall *rseqData)
{
