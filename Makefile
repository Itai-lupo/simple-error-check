...
INCLUDE_DIR := ./include/ ./include/dataStructures/ ./include/files/ ./include/sockets/ ./include/memoryMangment/
SRC_DIRS := ./src/ 
TESTS_DIR := ./tests
...
PCH_PATH := ./include/utils.hpp
PCH_OUT := $(BUILD_DIR)/include/utils.hpp.pch
...
DEPS := $(BUILD_DIR)/include/utils.hpp.d
